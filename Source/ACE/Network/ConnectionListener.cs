...
namespace ACE.Network
{
    public class ConnectionListener
    {
        ...
        private string ipAddress = ConfigManager.Config.Server.Network.Host;
        ...
        public void Start()
        {
            try
            {
                listenerEndpoint = new IPEndPoint(IPAddress.Parse(ipAddress), (int)listeningPort);
        ...
        private void Listen()
        {
            try
            {
                EndPoint clientEndPoint = new IPEndPoint(IPAddress.Parse(ipAddress), 0);
